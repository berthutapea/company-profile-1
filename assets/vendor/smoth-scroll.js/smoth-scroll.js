      ...
      return function (r, g) {
        ...
        (C.cancelScroll = function (e) {
          ...
          (C.animateScroll = function (n, i, r) {
            ...
            if (u || g) {
              var w = e.pageYOffset;
              a.header && !E && (E = document.querySelector(a.header)),
                b || (b = m(E));
              var y,
                S,
                O,
                ...
                x = function (t, o) {
                  var r = e.pageYOffset;
                  if (t == o || r == o || (w < o && e.innerHeight + r) >= M)
                    return (
                      C.cancelScroll(!0),
                      h(n, o, u),
                      p("scrollStop", a, n, i),
                ...
                H = function (t) {
                  y || (y = t),
                    ...
                    (S = S > 1 ? 1 : S),
                    (O = w + q * c(a, S)),
                    e.scrollTo(0, Math.floor(O)),
                    x(O, I) || ((A = e.requestAnimationFrame(H)), (y = t));
                };
        ...
        var O = function (t) {
          if (
            ...
            (o = o || "#top" !== n ? o : document.documentElement),
              o && (t.preventDefault(), C.animateScroll(o, y));
          }
        },
          I = function (e) {
            if (
        ...
        return (
          (C.destroy = function () {
            v &&
              (document.removeEventListener("click", O, !1),
                e.removeEventListener("resize", q, !1),
          ...
          (C.init = function (i) {
            ...
            C.destroy(),
              (v = o(t, i || {})),
              (E = v.header ? document.querySelector(v.header) : null),
              (b = m(E)),
              document.addEventListener("click", O, !1),
              E && e.addEventListener("resize", q, !1),
              v.updateURL &&
              v.popstate &&
              e.addEventListener("popstate", I, !1);
          }),
          C.init(g),
          C
        );
